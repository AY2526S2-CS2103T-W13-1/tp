 ...
 * A property is considered unique by comparing using {@code isSameProperty}.
 * As such, adding and updating of properties uses {@code isSameProperty} for equality so as to
 * ensure that the property being added or updated is unique in terms of identity in the UniquePropertyList.
 * However, the removal of a property uses {@code equals}, as the property has to be exactly the same as the one
 * in the UniquePropertyList.
 */
